# LP-LICENSE
### 1. 라이선스의 적용 범위
이 라이선스가 적용된 저작물을 사용하거나 이 라이선스가 적용된 저작물을 기반으로 하는 경우에 소스를 공개해야할 의무가 있다.
누구나 이 라이센스를 사용할 수 있지만, 본문에 대한 수정을 허가되지 않는다.

### 2. 상업적 사용의 범주
* 상업적 사용의 정의
```
프로그램 코드를 상업적으로 사용하는 행위
저작물을 이용해 상업적 이용(판매 등)을 하는 경우 (서버에서 후원 받는 경우는 제외함)
```
이 라이선스의 적용 범위에 해당되는 저작물은 저작자와 합의 이후에 사용할 수 있다. 사전 합의 없이 상업적 이용 시에는 저작권 침해로 간주한다.
